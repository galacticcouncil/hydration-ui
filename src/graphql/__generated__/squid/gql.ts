 ...
 */
type Documents = {
    "query OmnipoolYieldMetrics {\n  omnipoolAssetsYieldMetrics {\n    nodes {\n      assetId\n      projectedAprPerc\n    }\n  }\n}\n\nquery StableswapYieldMetrics($filter: StableswapYieldMetricsFilter!) {\n  stableswapYieldMetrics(filter: $filter) {\n    nodes {\n      poolId\n      projectedAprPerc\n      projectedApyPerc\n    }\n  }\n}": typeof types.OmnipoolYieldMetricsDocument,
    ...
    "query SwapAssetFeesByPeriod($filter: SwapAssetFeesByPeriodFilter!) {\n  swapAssetFeesByPeriod(filter: $filter) {\n    nodes {\n      assetId\n      amount\n    }\n    totalCount\n  }\n}": typeof types.SwapAssetFeesByPeriodDocument,
};
const documents: Documents = {
    "query OmnipoolYieldMetrics {\n  omnipoolAssetsYieldMetrics {\n    nodes {\n      assetId\n      projectedAprPerc\n    }\n  }\n}\n\nquery StableswapYieldMetrics($filter: StableswapYieldMetricsFilter!) {\n  stableswapYieldMetrics(filter: $filter) {\n    nodes {\n      poolId\n      projectedAprPerc\n      projectedApyPerc\n    }\n  }\n}": types.OmnipoolYieldMetricsDocument,
    "fragment Supply on MmSupply {\n  asset {\n    assetRegistryId\n  }\n  amount\n}\n\nfragment Withdraw on MmWithdraw {\n  asset {\n    assetRegistryId\n  }\n  amount\n}\n\nfragment Borrow on MmBorrow {\n  asset {\n    assetRegistryId\n  }\n  amount\n}\n\nfragment Repay on MmRepay {\n  asset {\n    assetRegistryId\n  }\n  amount\n}\n\nfragment CollateralEnabled on MmReserveUsedAsCollateralEnabledEvent {\n  asset {\n    assetRegistryId\n  }\n}\n\nfragment CollateralDisabled on MmReserveUsedAsCollateralDisabledEvent {\n  asset {\n    assetRegistryId\n  }\n}\n\nfragment LiquidationCall on MmLiquidationCall {\n  asset: collateralAsset {\n    assetRegistryId\n  }\n  amount: liquidatedCollateralAmount\n}\n\nfragment UserEMode on MmUserEModeSet {\n  categoryId\n}\n\nfragment EventData on MoneyMarketEvent {\n  supply {\n    ...Supply\n  }\n  withdraw {\n    ...Withdraw\n  }\n  borrow {\n    ...Borrow\n  }\n  repay {\n    ...Repay\n  }\n  reserveUsedAsCollateralEnabled {\n    ...CollateralEnabled\n  }\n  reserveUsedAsCollateralDisabled {\n    ...CollateralDisabled\n  }\n  liquidationCall {\n    ...LiquidationCall\n  }\n  userEModeSet {\n    ...UserEMode\n  }\n}\n\nfragment MoneyMarketEvent on MoneyMarketEvent {\n  ...EventData\n  eventName\n  event {\n    block {\n      timestamp\n    }\n  }\n}\n\nquery MoneyMarketEvents($filter: MoneyMarketEventFilter, $first: Int, $offset: Int) {\n  moneyMarketEvents(\n    first: $first\n    offset: $offset\n    filter: $filter\n    orderBy: [EVENT_ID_DESC]\n  ) {\n    totalCount\n    nodes {\n      ...MoneyMarketEvent\n    }\n  }\n}": types.SupplyFragmentDoc,
    "query SwapAssetFeesByPeriod($filter: SwapAssetFeesByPeriodFilter!) {\n  swapAssetFeesByPeriod(filter: $filter) {\n    nodes {\n      assetId\n      amount\n    }\n    totalCount\n  }\n}": types.SwapAssetFeesByPeriodDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query OmnipoolYieldMetrics {\n  omnipoolAssetsYieldMetrics {\n    nodes {\n      assetId\n      projectedAprPerc\n    }\n  }\n}\n\nquery StableswapYieldMetrics($filter: StableswapYieldMetricsFilter!) {\n  stableswapYieldMetrics(filter: $filter) {\n    nodes {\n      poolId\n      projectedAprPerc\n      projectedApyPerc\n    }\n  }\n}"): (typeof documents)["query OmnipoolYieldMetrics {\n  omnipoolAssetsYieldMetrics {\n    nodes {\n      assetId\n      projectedAprPerc\n    }\n  }\n}\n\nquery StableswapYieldMetrics($filter: StableswapYieldMetricsFilter!) {\n  stableswapYieldMetrics(filter: $filter) {\n    nodes {\n      poolId\n      projectedAprPerc\n      projectedApyPerc\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query SwapAssetFeesByPeriod($filter: SwapAssetFeesByPeriodFilter!) {\n  swapAssetFeesByPeriod(filter: $filter) {\n    nodes {\n      assetId\n      amount\n    }\n    totalCount\n  }\n}"): (typeof documents)["query SwapAssetFeesByPeriod($filter: SwapAssetFeesByPeriodFilter!) {\n  swapAssetFeesByPeriod(filter: $filter) {\n    nodes {\n      assetId\n      amount\n    }\n    totalCount\n  }\n}"];
