...
const PrivacyUnshieldFlow = lazy(async () => ({
  default: (await import("sections/privacy")).UnshieldFlow,
}))

const PrivacySendFlow = lazy(async () => ({
  default: (await import("sections/privacy")).SendFlow,
}))
