...
export const SGigadotStrategy = styled.div`
  --gigadot-strategy-padding-block: 60px;
  ...
  padding-block: var(--gigadot-strategy-padding-block);
  padding-left: 30px;
  padding-right: 40px;
...
export const SGigadotStrategySeparator = styled(Separator)`
  @media ${theme.viewport.gte.sm} {
    margin-block: calc(-1 * var(--gigadot-strategy-padding-block));
  }
`
