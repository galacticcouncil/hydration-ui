...
export function WalletTransferSectionOnchain(props: {
  ...
  const assetMeta = useAssetMeta(props.asset)
  ...
  const { data: paymentInfoData } = usePaymentInfo(
    props.asset === NATIVE_ASSET_ID
      ? api.tx.balances.transferKeepAlive("", "0")
      : api.tx.tokens.transferKeepAlive("", props.asset, "0"),
  )
          ...
          <Controller
            ...
            render={({
              ...
              <WalletTransferAssetSelect
                ...
                asset={props.asset}
                error={error?.message}
                onAssetOpen={props.openSelectAssetModal}
              />
            )}
          />
          {props.asset !== "0" && (
