...
export const usePOLData = () => {
  ...
  const data = useMemo(() => {
    ...
    return omnipoolAssets.data.map((omnipoolAsset) => {
...
export type TPOLStats = typeof usePOLData
export type TPOLStatsData = ReturnType<TPOLStats>["data"]
