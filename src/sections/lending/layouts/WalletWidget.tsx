...
import { WalletModal } from "sections/lending/components/WalletConnection/WalletModal"
          ...
          {readOnlyModeAddress && (
            <Warning
              ...
              sx={{
                mt: 3,
                mb: 0,
                ...(md ? { background: "#301E04", color: "#FFDCA8" } : {}),
              }}
            >
  ...
  return (
    <>
      ...
      {md ? (
        ...
        >
          <List
            sx={{ px: 2, ".MuiListItem-root.Mui-disabled": { opacity: 1 } }}
          >
            <Content />
          </List>
        </DrawerWrapper>
