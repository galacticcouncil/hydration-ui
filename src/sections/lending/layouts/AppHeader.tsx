...
export function AppHeader() {
  ...
  const testnetTooltip = (
    ...
    >
      <Typography variant="subheader1">
        <span>Testnet mode is ON</span>
      </Typography>
      <Typography variant="description">
        <span>The app is running in testnet mode. Learn how it works in</span>{" "}
        <Link
  ...
  const forkTooltip = (
    ...
    >
      <Typography variant="subheader1">
        <span>Fork mode is ON</span>
      </Typography>
      <Typography variant="description">
        <span>The app is running in fork mode.</span>
      </Typography>
  ...
  return (
    <HideOnScroll>
      ...
      >
        ...
        >
          <img
            src="https://app.aave.com/aaveLogo.svg"
            alt="AAVE"
            width={72}
            height={20}
          />
