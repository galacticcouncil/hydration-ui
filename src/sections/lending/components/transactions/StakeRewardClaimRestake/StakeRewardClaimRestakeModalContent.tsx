...
export const StakeRewardClaimRestakeModalContent = ({
  ...
  const amountInUsd =
    ...
    Number(normalize(stakeData?.stakeTokenPriceUSD || 1, 18))
  // error handler
  ...
  const handleBlocked = () => {
    switch (blockingError) {
      case ErrorType.NOT_ENOUGH_BALANCE:
        return <span>No rewards to claim</span>
      default:
        return null
    }
  }
  ...
  return (
    <>
      ...
      <CooldownWarning />
      <AssetInput
        name="reward-claim-restake-amount"
        value={amount}
        ...
        balanceText={<span>Amount claimable</span>}
      />
