...
import { useGovernanceDelegate } from "sections/lending/helpers/useGovernanceDelegate"

import { DelegationTxsWrapper } from "sections/lending/components/transactions/DelegationTxsWrapper"
...
export const GovDelegationActions = ({
  ...
  const { signMetaTxs, action, mainTxState, loadingTxns, approvalTxState } =
    useGovernanceDelegate(
      delegationTokenType,
      delegationType,
      blocked,
      delegatee,
