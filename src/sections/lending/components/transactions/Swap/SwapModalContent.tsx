...
import { getDebtCeilingData } from "sections/lending/hooks/useAssetCaps"
...
import { remainingCap } from "sections/lending/utils/getMaxAmountAvailableToSupply"
import { calculateHFAfterSwap } from "sections/lending/utils/hfUtils"
...
export const SwapModalContent = ({
  ...
  const { currentChainId, currentMarket, currentNetworkConfig } =
  ...
  return (
    <>
      ...
      <AssetInput
        ...
        inputTitle={<span>Supplied asset amount</span>}
      ...
      {swapTarget.reserve.symbol === "stETH" && (
        <Warning variant="warning" sx={{ mt: 8, mb: 0 }}>
