...
import { useParaswapSellTxParams } from "sections/lending/hooks/paraswap/useParaswapRates"
...
export const SwitchActions = ({
  ...
  const useSignature =
    walletApprovalMethodPreference === ApprovalMethod.PERMIT && tryPermit
  ...
  return (
    <TxActionsWrapper
      ...
      actionText={<span>Switch</span>}
      actionInProgressText={<span>Switching</span>}
      errorParams={{
        loading: false,
        disabled: blocked || (!approvalTxState.success && requiresApproval),
        content: <span>Switch</span>,
        handleClick: action,
      }}
