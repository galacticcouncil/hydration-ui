    ...
    >
      <Box
        ...
        sx={(theme) => ({
          ...
          display: "flex",
          backgroundColor:
            theme.palette.mode === "dark" ? "#39375A80" : "#C9B3F94D",
          position: "relative",
          alignItems: {
            xs: "none",
            xsm: "center",
      ...
      >
        <Box
          component="img"
          src="https://app.aave.com/illustration_desktop.png"
          alt="ghost and coin"
          sx={{
        ...
        >
          ...
          >
            ...
            >
              A decentralized, multi-collateralized stablecoin created by
              AaveDAO.
            </Typography>
          </Box>
          <Box
