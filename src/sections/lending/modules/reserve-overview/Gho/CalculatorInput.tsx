...
import { NumberFormatCustom } from "sections/lending/components/transactions/AssetInput"
      ...
      <Tooltip
        ...
        title={
          <Box sx={{ width: 150, textAlign: "center" }}>
            <span>You may enter a custom amount in the field.</span>
          </Box>
        }
      >
        <Box />
