...
export interface IGhoPieChartContainer {
...
export const GhoPieChartContainer = ({
  ...
  rateAfterDiscount,
}: IGhoPieChartContainer) => {
  const { breakpoints } = useTheme()
  const downToXsm = useMediaQuery(breakpoints.down("xsm"))

  const amountAtDiscount = discountableAmount || 0
  const amountThatExceedsDiscount = Math.max(
    0,
    (borrowAmount || 0) - amountAtDiscount,
  )
          ...
          >
            <TableCell align="left" sx={{ pl: 0 }}>
              <Stack direction="row" alignItems="center" gap={1}>
                ...
                />
                <Typography variant="caption">
                  <span>Exceeds the discount</span>
                </Typography>
              </Stack>
            </TableCell>
            <TableCell align="right">
