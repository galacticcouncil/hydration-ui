  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <VoteBar
          percent={votingInfo.againstPercent}
          votes={votingInfo.againstVotes}
          compact
        />
      </Stack>
    </Box>
...
const getProposalTimestamp = (proposal: Proposal) => {
  ...
  const votingMachineStartTime = Number(
    proposal.transactions.active?.timestamp || 0,
  )
