...
import { SlippageTooltip } from "sections/lending/components/infoTooltips/SlippageTooltip"

import Paraswap from "sections/lending/assets/icons/other/paraswap.svg?react"
      ...
      >
        <Box sx={{ px: "16px", py: "12px" }}>
          <Typography variant="secondary12" color="text.secondary">
            <span>Select slippage tolerance</span>
          </Typography>
        </Box>
