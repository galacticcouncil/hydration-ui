...
const sepoliaVotingMachineConfig: VotingMachineConfig = {
  portalToMachineMap: {
    "0x1079bAa48E56065d43b4344866B187a485cb0A92":
...
const fujiVotingMachineConfig: VotingMachineConfig = {
  portalToMachineMap: {
    "0x4f47EdF2577995aBd7B875Eed75b3F28a20E696F":
      "0x767AA57554690D23D1E0594E8746271C97e1A1e4",
  },
  votingPortalDataHelperAddress: "0x133210F3fe2deEB34e65deB6861ee3dF87393977",
...
export const governanceChainConfig: GovernanceChainConfig = {
  [ChainId.sepolia]: {
    ...
    governanceCoreSubgraphUrl:
      "https://api.thegraph.com/subgraphs/name/grothem/gov-v3-sepolia",
    votingChainConfig: {
  ...
  [ChainId.mainnet]: {
    ...
    governanceCoreSubgraphUrl:
      "https://api.thegraph.com/subgraphs/name/aave/governance-v3",
    votingChainConfig: {
      [ChainId.mainnet]: {
        portalToMachineMap: {
