...
import { BorrowCapMaxedTooltip } from "sections/lending/components/infoTooltips/BorrowCapMaxedTooltip"
...
import { BorrowCapWarning } from "sections/lending/components/transactions/Warnings/BorrowCapWarning"
import { DebtCeilingWarning } from "sections/lending/components/transactions/Warnings/DebtCeilingWarning"
import { SupplyCapWarning } from "sections/lending/components/transactions/Warnings/SupplyCapWarning"
...
export const getDebtCeilingData = (asset: ComputedReserveData) => {
  let debtCeilingUsage: number = asset
    ? valueToBigNumber(asset.isolationModeTotalDebt)
        .dividedBy(asset.debtCeiling)
        .toNumber() * 100
    : 0
