...
export const getBlacklistedWallets = (mode: WalletMode) => {
  ...
  const allowedModes: Record<WalletMode, WalletMode[]> = {
    [WalletMode.Solana]: [WalletMode.Solana],
    [WalletMode.Sui]: [WalletMode.Sui],
    [WalletMode.EVM]: [WalletMode.EVM],
    [WalletMode.SubstrateEVM]: [
      WalletMode.EVM,
      WalletMode.Substrate,
      WalletMode.Default,
    ],
    [WalletMode.Substrate]: [WalletMode.Substrate],
    [WalletMode.SubstrateH160]: [WalletMode.SubstrateH160],
    [WalletMode.Default]: allWalletModes,
  }

  const allowed = allowedModes[mode]
