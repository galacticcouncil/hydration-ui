...
import type { AccountId32, Percent, Permill, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { FrameSupportPalletId, FrameSupportWeightsPays, FrameSupportWeightsRuntimeDbWeight, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, SpVersionRuntimeVersion, XcmV1MultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/consts' {
  interface AugmentedConsts<ApiType extends ApiTypes> {
    ...
    multiTransactionPayment: {
       ...
       **/
      withdrawFeeForSetCurrency: FrameSupportWeightsPays & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
