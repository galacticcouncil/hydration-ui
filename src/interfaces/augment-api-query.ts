...
import type { AccountId32, Call, H256, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, FrameSupportWeightsPerDispatchClassWeight, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, HydradxRuntimeAssetLocation, HydradxRuntimeOpaqueSessionKeys, HydradxTraitsOracleOraclePeriod, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlTokensReserveData, OrmlVestingVestingSchedule, PalletAssetRegistryAssetDetails, PalletAssetRegistryAssetMetadata, PalletAuthorshipUncleEntryItem, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletCircuitBreakerLiquidityLimit, PalletCircuitBreakerTradeVolumeLimit, PalletClaimsEthereumAddress, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletDemocracyPreimageStatus, PalletDemocracyReferendumInfo, PalletDemocracyReleases, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletElectionsPhragmenSeatHolder, PalletElectionsPhragmenVoter, PalletEmaOracleOracleEntry, PalletGenesisHistoryChain, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletLiquidityMiningDepositData, PalletLiquidityMiningGlobalFarmData, PalletLiquidityMiningYieldFarmData, PalletMultisigMultisig, PalletOmnipoolAssetState, PalletOmnipoolPosition, PalletOmnipoolSimpleImbalance, PalletOmnipoolTradability, PalletOtcOrder, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduledV3, PalletTipsOpenTip, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletUniquesCollectionDetails, PalletUniquesCollectionMetadata, PalletUniquesItemDetails, PalletUniquesItemMetadata, PalletXcmQueryStatus, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV2AbridgedHostConfiguration, PolkadotPrimitivesV2PersistedValidationData, PolkadotPrimitivesV2UpgradeRestriction, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof, XcmV1MultiLocation, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      assetLocations: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<HydradxRuntimeAssetLocation>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      locationAssets: AugmentedQuery<ApiType, (arg: HydradxRuntimeAssetLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<u32>>, [HydradxRuntimeAssetLocation]> & QueryableStorageEntry<ApiType, [HydradxRuntimeAssetLocation]>;
      /**
    ...
    circuitBreaker: {
       ...
       **/
      allowedAddLiquidityAmountPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletCircuitBreakerLiquidityLimit>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Remove liquidity volumes per asset
       **/
      allowedRemoveLiquidityAmountPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletCircuitBreakerLiquidityLimit>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Trade volumes per asset
       **/
      allowedTradeVolumeLimitPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletCircuitBreakerTradeVolumeLimit>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Liquidity limits of assets for adding liquidity.
       * If not set, returns the default limit.
       **/
      liquidityAddLimitPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[u32, u32]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Liquidity limits of assets for removing liquidity.
       * If not set, returns the default limit.
       **/
      liquidityRemoveLimitPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[u32, u32]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Trade volume limits of assets set by set_trade_volume_limit.
       * If not set, returns the default limit.
       **/
      tradeVolumeLimitPerAsset: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<ITuple<[u32, u32]>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    claims: {
       ...
       **/
      claims: AugmentedQuery<ApiType, (arg: PalletClaimsEthereumAddress | string | Uint8Array) => Observable<u128>, [PalletClaimsEthereumAddress]> & QueryableStorageEntry<ApiType, [PalletClaimsEthereumAddress]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    omnipool: {
       ...
       **/
      assets: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletOmnipoolAssetState>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Imbalance of hub asset
       **/
      hubAssetImbalance: AugmentedQuery<ApiType, () => Observable<PalletOmnipoolSimpleImbalance>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Tradable state of hub asset.
       **/
      hubAssetTradability: AugmentedQuery<ApiType, () => Observable<PalletOmnipoolTradability>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Position ids sequencer
       **/
      nextPositionId: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * LP positions. Maps NFT instance id to corresponding position
       **/
      positions: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletOmnipoolPosition>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * TVL cap
       **/
      tvlCap: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    omnipoolLiquidityMining: {
       ...
       **/
      omniPositionId: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    omnipoolWarehouseLM: {
       ...
       **/
      activeYieldFarm: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32, u32]> & QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       * Deposit details.
       **/
       ...
       * Yield farm details.
       **/
      yieldFarm: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletLiquidityMiningYieldFarmData>>, [u32, u32, u32]> & QueryableStorageEntry<ApiType, [u32, u32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    otc: {
       ...
       **/
      nextOrderId: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      orders: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletOtcOrder>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<HydradxRuntimeOpaqueSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, HydradxRuntimeOpaqueSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
