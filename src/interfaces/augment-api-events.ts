...
import type { AccountId32, H256, Permill, Perquintill, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { CommonRuntimeProxyType, FrameSupportScheduleLookupError, FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, HydradxRuntimeAssetLocation, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletClaimsEthereumAddress, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletLiquidityMiningLoyaltyCurve, PalletMultisigTimepoint, PalletOmnipoolTradability, SpRuntimeDispatchError, XcmV1MultiAsset, XcmV1MultiLocation, XcmV1MultiassetMultiAssets, XcmV2Response, XcmV2TraitsError, XcmV2TraitsOutcome, XcmV2Xcm, XcmVersionedMultiAssets, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      LocationSet: AugmentedEvent<ApiType, [assetId: u32, location: HydradxRuntimeAssetLocation], { assetId: u32, location: HydradxRuntimeAssetLocation }>;
      /**
       ...
       * Asset was updated.
       **/
      Updated: AugmentedEvent<ApiType, [assetId: u32, assetName: Bytes, assetType: PalletAssetRegistryAssetType], { assetId: u32, assetName: Bytes, assetType: PalletAssetRegistryAssetType }>;
      /**
       * Generic event
       **/
    ...
    omnipool: {
       ...
       * Buy trade executed.
       **/
      BuyExecuted: AugmentedEvent<ApiType, [who: AccountId32, assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128], { who: AccountId32, assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128 }>;
      /**
       ...
       **/
      LiquidityRemoved: AugmentedEvent<ApiType, [who: AccountId32, positionId: u128, assetId: u32, sharesRemoved: u128], { who: AccountId32, positionId: u128, assetId: u32, sharesRemoved: u128 }>;
      /**
       ...
       * Sell trade executed.
       **/
      SellExecuted: AugmentedEvent<ApiType, [who: AccountId32, assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128], { who: AccountId32, assetIn: u32, assetOut: u32, amountIn: u128, amountOut: u128 }>;
      /**
    ...
    omnipoolLiquidityMining: {
       ...
       **/
      GlobalFarmUpdated: AugmentedEvent<ApiType, [id: u32, lrnaPriceAdjustment: u128], { id: u32, lrnaPriceAdjustment: u128 }>;
      /**
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: CommonRuntimeProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: CommonRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CommonRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: CommonRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: CommonRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: CommonRuntimeProxyType, delay: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
