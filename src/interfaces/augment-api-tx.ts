...
import type { AccountId32, Call, H256, Perbill, Permill, Perquintill, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { CommonRuntimeProxyType, CumulusPrimitivesParachainInherentParachainInherentData, FrameSupportScheduleMaybeHashed, HydradxRuntimeAssetLocation, HydradxRuntimeOpaqueSessionKeys, HydradxRuntimeOriginCaller, OrmlVestingVestingSchedule, PalletAssetRegistryAssetType, PalletAssetRegistryMetadata, PalletClaimsEcdsaSignature, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletElectionsPhragmenRenouncing, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletLiquidityMiningLoyaltyCurve, PalletMultisigTimepoint, PalletOmnipoolTradability, PalletUniquesDestroyWitness, SpRuntimeHeader, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetRegistry: {
       ...
       **/
      register: AugmentedSubmittable<(name: Bytes | string | Uint8Array, assetType: PalletAssetRegistryAssetType | { Token: any } | { PoolShare: any } | string | Uint8Array, existentialDeposit: u128 | AnyNumber | Uint8Array, assetId: Option<u32> | null | Uint8Array | u32 | AnyNumber, metadata: Option<PalletAssetRegistryMetadata> | null | Uint8Array | PalletAssetRegistryMetadata | { symbol?: any; decimals?: any } | string, location: Option<HydradxRuntimeAssetLocation> | null | Uint8Array | HydradxRuntimeAssetLocation | { parents?: any; interior?: any } | string) => SubmittableExtrinsic<ApiType>, [Bytes, PalletAssetRegistryAssetType, u128, Option<u32>, Option<PalletAssetRegistryMetadata>, Option<HydradxRuntimeAssetLocation>]>;
      /**
       ...
       **/
      setLocation: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, location: HydradxRuntimeAssetLocation | { parents?: any; interior?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, HydradxRuntimeAssetLocation]>;
      /**
       ...
       **/
      update: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, name: Bytes | string | Uint8Array, assetType: PalletAssetRegistryAssetType | { Token: any } | { PoolShare: any } | string | Uint8Array, existentialDeposit: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u32, Bytes, PalletAssetRegistryAssetType, Option<u128>]>;
      /**
       * Generic tx
       **/
    ...
    council: {
       ...
       * # </weight>
       **/
      close: AugmentedSubmittable<(proposalHash: H256 | string | Uint8Array, index: Compact<u32> | AnyNumber | Uint8Array, proposalWeightBound: Compact<WeightV1> | AnyNumber | Uint8Array, lengthBound: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Compact<u32>, Compact<WeightV1>, Compact<u32>]>;
      /**
    ...
    omnipoolLiquidityMining: {
       ...
       * 
       **/
      updateGlobalFarm: AugmentedSubmittable<(globalFarmId: u32 | AnyNumber | Uint8Array, lrnaPriceAdjustment: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u128]>;
      /**
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CommonRuntimeProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId32 | string | Uint8Array, proxyType: CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CommonRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<CommonRuntimeProxyType> | null | Uint8Array | CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<CommonRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<CommonRuntimeProxyType> | null | Uint8Array | CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<CommonRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: CommonRuntimeProxyType | 'Any' | 'CancelProxy' | 'Governance' | 'Transfer' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, CommonRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
