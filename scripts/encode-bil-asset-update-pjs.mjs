// Same encoder as encode-bil-asset-update.mjs but using @polkadot/api
...
//
// Usage:
//   node --experimental-vm-modules scripts/encode-bil-asset-update-pjs.mjs
//
