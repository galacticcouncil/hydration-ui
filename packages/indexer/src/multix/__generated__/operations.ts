...
export type MultisigHistoryByAccountIdQueryVariables = Types.Exact<{
...
export type MultisigHistoryByAccountIdQuery = { __typename?: 'Query', multisigCalls: Array<{ __typename?: 'MultisigCall', id: string, timestamp: unknown, blockHash: string, callIndex: number, multisig?: { __typename?: 'Account', id: string, pubKey: string, isMultisig?: boolean | null, isPureProxy?: boolean | null, threshold?: number | null, signatories: Array<{ __typename?: 'AccountMultisig', id: string, signatory: { __typename?: 'Account', id: string, pubKey: string } }> } | null }> };
