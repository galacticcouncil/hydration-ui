...
export const WalletManagementContent = () => {
  ...
  useLayoutEffect(() => {
    setModalContentWidth?.(showAccountPanel ? "40rem" : "28.25rem")
          ...
          >
            ...
            showExternalWallet ? (
              ...
              <Flex direction="column" gap="base" sx={rightColumnSx}>
                ...
                <Box sx={accountScrollFrameSx}>
                  <ScrollArea sx={{ height: "100%" }}>
                    <Flex
                      direction="column"
                      gap="base"
                      sx={accountScrollContentSx}
                    >
    ...
    <Flex align="center" justify="center" sx={walletConnectStateSx}>
      <Flex direction="column" align="center" gap="base" sx={{ width: "100%" }}>
        <Image
          src={wallet.logo}
          alt=""
          sx={{ size: "2xl", borderRadius: "full", flexShrink: 0 }}
        />
        ...
        >
          {isConnecting ? (
            ...
            <Icon size="s" component={Download} />
          ) : (
            <Icon size="s" component={WalletIcon} />
          )}
          {!wallet.installed
    ...
    <Flex align="center" sx={sourceButtonContentSx}>
      {logo ? (
        <Image
          ...
          alt=""
          lazy={false}
          sx={{ size: "l", flexShrink: 0, objectFit: "contain" }}
        />
      ) : icon ? (
        <Box sx={sourceIconSx}>
  ...
  return (
    <Box>
      ...
      >
        ...
        <Flex direction="column" sx={{ minWidth: 0, flex: 1 }}>
          <Flex
            align="center"
...
const walletManagementShellSx = (
  ...
  width: ["100%", null, showAccountPanel ? "40rem" : "28.25rem"],
  maxWidth: "100%",
...
const rightPanelFrameSx = (showAccountPanel: boolean): BoxProps["sx"] => ({
  ...
  display: "flex",
  flexDirection: "column",
  overflow: showAccountPanel ? "visible" : "hidden",
...
const accountScrollFrameSx: BoxProps["sx"] = {
  flex: 1,
  minHeight: 0,
  overflow: "hidden",
  mr: ["-base", null, "-m"],
...
const accountScrollContentSx: BoxProps["sx"] = {
  display: "flex",
  flexDirection: "column",
  gap: "base",
  pr: ["base", null, "m"],
