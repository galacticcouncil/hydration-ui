...
export type OrdersStateQuery = { __typename?: 'Query', events: Array<{ __typename?: 'Event', name: string, args?: any | null }> };


export const OrdersStateDocument = gql`
    query OrdersState($offerId: Int!) {
  events(
    where: {args_jsonContains: {orderId: $offerId}, AND: {name_eq: "OTC.Placed"}}
  ) {
    name
    args
  }
