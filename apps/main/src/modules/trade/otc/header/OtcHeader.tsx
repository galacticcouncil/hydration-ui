...
export const OtcHeader: FC = () => {
  ...
  return (
    <SOtcHeader>
      <OtcValue label={t("trade.otc.header.otcValue")} price={10301874} />
      <Separator display={["block", "none"]} />
      <OtcValue label={t("trade.otc.header.sold")} price={10301874} />
      <Separator display={["block", "none"]} />
      <OtcValue label={t("trade.otc.header.24volume")} price={10301874} />
    </SOtcHeader>
  )
}
