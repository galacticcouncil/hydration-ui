...
import { PastTransactionData } from "@/modules/trade/orders/PastTransactions/usePastTransactionsData"
import { TAsset } from "@/providers/assetsProvider"

type Props = {
  readonly assetIn: TAsset
  readonly assetOut: TAsset
  readonly executions: Array<PastTransactionData>
}

export const PastTransactionsList: FC<Props> = ({
  assetIn,
  assetOut,
  executions,
}) => {
