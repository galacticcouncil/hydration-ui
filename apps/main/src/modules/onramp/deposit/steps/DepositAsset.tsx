          ...
          >
            {asset ? (
              <Flex align="center" gap="xs">
                ...
                <Text fs="p4" fw={600} color={getToken("text.high")} ml="xs">
            ...
            <Icon component={ChevronDown} size="m" sx={{ ml: "auto" }} />
          </Button>
              ...
              {isAccountAllowed && (
                <>
                  <Flex justify="center">
                    ...
                    >
                      <Icon component={Spinner} size="m" ml="-s" />
                      <Text fs="p5" lh={1} fw={600} transform="uppercase">
