...
export const useCBreakerOutboundLimitAlerts = (
  ...
  return useMemo<XcmAlert[]>(() => {
    ...
    if (data.lockdown) {
      ...
      return [
        {
          key: XcmLimitAlertKey.CBreakerOutboundLockdown,
          title: t("limit.circuitBreaker"),
          message: [t("limit.alert.cBreaker.outbound.locked"), lockdownText]
            .filter(Boolean)
            .join(" "),
          severity: "error",
        },
    ...
    if (withdrawalUsd && headroomUsd && withdrawalUsd.gt(headroomUsd)) {
      ...
      return [
        {
          key: XcmLimitAlertKey.CBreakerOutboundExceeded,
          title: t("limit.circuitBreaker"),
          message: t("limit.alert.cBreaker.outbound.exceeded", {
