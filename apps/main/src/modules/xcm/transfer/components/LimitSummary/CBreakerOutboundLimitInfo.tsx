...
export type CBreakerOutboundLimitInfoProps = {
  globalWithdrawLimit: GlobalWithdrawLimit
  headroomUsd: string
}

export const CBreakerOutboundLimitInfo: React.FC<
  CBreakerOutboundLimitInfoProps
> = ({ globalWithdrawLimit, headroomUsd }) => {
  ...
  return (
    <Stack gap="base">
      <Text fs="p4">{t("xcm:limit.cBreaker.outbound.description")}</Text>
