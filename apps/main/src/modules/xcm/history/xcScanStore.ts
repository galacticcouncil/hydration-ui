...
export const xcScanHttpClient = new OcelloidsHttpClient(apiUrl, apiKey)
export const xcScanSseClient = new OcelloidsSseClient(apiUrl)

export const xcStore = new XcStore(xcScanHttpClient, xcScanSseClient)
