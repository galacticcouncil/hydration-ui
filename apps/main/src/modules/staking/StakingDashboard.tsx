...
export const StakingDashboard: FC = () => {
  ...
  const { data: stakingPositionsData, isPending: stakingPositionsLoading } =
  ...
  const rawAvailableBalance = Big(getFreeBalance(native.id).toString())
    .minus(vested)
            ...
            {stakingPositionsLoading ? (
              ...
              <>
                ...
                <DashboardStats
                  positionId={positionId}
                  staked={staked}
                  isStakeLoading={stakingPositionsLoading}
                />
              </>
            )}
          </Paper>
