...
export const Referenda: FC<Props> = ({
  ...
  const threshold = Big(sum.toString())
    .div(100)
    .times(thresholdPercentage ?? 0)
    .toString()
  ...
  return (
    <SReferenda voted={voted}>
      ...
      <ReferendaStatus
        ...
        thresholdValue={scaleHuman(threshold, native.decimals)}
      ...
      <ReferendaFooter id={id} end={item.end} voted={voted} />
    </SReferenda>
  )
}
