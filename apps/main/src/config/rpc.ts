...
export const PROVIDERS: ProviderProps[] = [
  ...
  // createProvider("zipp", "wss://node.zipp.hydration.cloud"),
  createProvider("sin", "wss://node.sin.hydration.cloud"),
  createProvider("roach", "wss://node.roach.hydration.cloud"),
  createProvider("coke", "wss://node.coke.hydration.cloud"),
  createProvider("lait", "wss://node.lait.hydration.cloud"),
  createProvider("parm", "wss://node.parm.hydration.cloud"),
